...
export const menuData = [
    ...
    { 
        ...
        items:[
            ...
            // الوجبة 1
            {id:"app-kh", img:"/Dirty55/ap01.webp", name:"سلطه خضراء", basePrice:5, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 2
            {id:"app-sl", img:"/Dirty55/ap02.webp", name:"سلطه سحايب", basePrice:7, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 3
            {id:"app-tb", img:"/Dirty55/ap03.webp", name:"تبوله", basePrice:7, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 4
            {id:"app-ht", img:"/Dirty55/ap04.webp", name:"حمص", basePrice:8, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 5
            {id:"app-bb", img:"/Dirty55/ap05.webp", name:"بابا غنوج", basePrice:8, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 6
            {id:"app-mt", img:"/Dirty55/ap06.webp", name:"متبل", basePrice:8, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 7
            {id:"app-yz", img:"/Dirty55/ap07.webp", name:"زبادي بالخيار", basePrice:5, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
            // الوجبة 8
            {id:"app-md", img:"/Dirty55/ap08.webp", name:"مخلل", basePrice:3, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"علبه", price:0}]}
        ]
    },
    { 
        section:"حلا", 
