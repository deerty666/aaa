// انسخ المحتوى الذي زودتني به هنا تماماً (export default menuData;)
...
const menuData = [
    ...
    { 
        ...
        items:[
            // الوجبة 1
            {id:"bev-p", img:"/aaa/dr01.webp", name:"ببسي", basePrice:0, availableIn: ['branch1', 'branch2', 'branch3'], options:[
                {name:"صغير", price:3},
                {name:"وسط", price:6},
                {name:"كبير", price:9}
            ]},
...
// (ضع هنا كل محتوى menuData.js الأصلي كما زودتني به)
];
